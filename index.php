...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light"><a href="index.html">Anil Kumar V.</a></h1>
  ...
  <!-- ======= Hero Section ======= -->
 <?php 
  $a=array("hero-bg1.jpg","hero-bg2.jpg");
  $random=array_rand($a,1); 
?>
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center" 
  style="background:url('assets/img/<?php echo $a[$random]; ?>') top center ; background-size: cover;"  >
    <div class="hero-container" data-aos="fade-in">
      <h1>Anil Kumar Vinnakota</h1>
      <p>I'm <span class="typed" data-typed-items="Web Application Developer,Hybrid Mobile App Developer,Full Stak Web Developer,Web Application Designer"></span></p>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Having 12 years of experience in IT industry, with an earned reputation for   meeting deadlines and delivering critical solutions.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Technical Lead / Associate Project Manager</h3>
            <p class="font-italic">
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              ...
              <p><em></em></p>
              <ul>
                <li>Hyderabad,Telangana, IN</li>
                <li>+91 9618249024</li>
                <li>anilv2k@gmail.com</li>
              </ul>
            </div>
